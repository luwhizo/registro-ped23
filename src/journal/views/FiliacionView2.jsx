...
export const Table=({ columns, data, updateMyData, skipPageReset })=> {
  ...
  return (
    ...
    <div className='tableContainer'>
      ...
      <caption> <Typography variant='h5' mt={1} mb={1}>FILIACIÓN DE ESTUDIANTES</Typography> </caption>
        <thead>
        ...
        accessor: 'numero',
      ...
      
          {
            ...
            columns: [
              ...
              {
                Header: 'Nombre de Padre o Madre de familia.',
                accessor: 'papamama',
              },
              {
                Header: 'Cel. Papá o Mamá',
                accessor: 'celpapamama',
              },
